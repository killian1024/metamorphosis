...
int file_target::rename() noexcept
{
    ...
    std::cout << spdios::set_light_blue_text << "Renaming "
              << spdios::set_yellow_text << fle_pth_.filename()
              << spdios::set_light_blue_text << " --> "
              << spdios::set_yellow_text << new_fle_pth.filename()
              << spdios::set_light_blue_text << " ...";
